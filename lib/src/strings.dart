import 'package:dyte_uikit/src/localization/app_local.dart';

import 'localization/arb_to_map.dart';

class DyteStrings {
  final String? arbPath;
  DyteStrings({this.arbPath});
  static DyteLocalization _localizations = DyteLocalization();

  Future<void> init() async {
    final loc = await Localize().init(arbPath!);
    _localizations = DyteLocalization(loc);
  }

  static String get locale => _localizations.locale;

  static const String dyte = 'Dyte';
