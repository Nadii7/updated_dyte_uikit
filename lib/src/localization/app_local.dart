import 'package:dyte_uikit/src/localization/arb_to_map.dart';

class DyteLocalization {
  String _locale = 'en';
  Map<String, String>? _localizedStrings;
  DyteLocalization([Localize? localize]) {
    if (localize != null) {
  ...
  String get dyte => _getLocalString("dyte") ?? 'Dyte';
