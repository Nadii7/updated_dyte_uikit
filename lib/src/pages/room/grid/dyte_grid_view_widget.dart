...
class DyteGridViewWidget extends StatefulWidget {
  const DyteGridViewWidget({
  ...
  @override
  State<DyteGridViewWidget> createState() => _DyteGridViewWidgetState();
}

class _DyteGridViewWidgetState extends State<DyteGridViewWidget> {
  late int rows;
