part of 'dyte_elevated_button.dart';

abstract class DyteButton extends StatefulWidget
    with UsesStatusColor
    implements UiKitElement {
  final DyteDesignTokens designToken;
  final VoidCallback? onPressed;
  final String? label;
  final DyteButtonController controller;
  DyteButton({
    super.key,
    required this.label,
...
// Solid Button
class _DyteSolidButton extends DyteButton {
  _DyteSolidButton({
  ...
  @override
  State<StatefulWidget> createState() => _DyteSolidButtonState();
}

class _DyteSolidButtonState extends State<_DyteSolidButton> {
...
class _DyteSolidIconButtonWithLabel extends DyteButton {
  ...
  @override
  State<StatefulWidget> createState() => _DyteSolidIconButtonWithLabelState();
}

class _DyteSolidIconButtonWithLabelState
    extends State<_DyteSolidIconButtonWithLabel> {
  @override
  Widget build(BuildContext context) {
    return MaterialButton(
...
class _DyteIconButton extends DyteButton {
  _DyteIconButton({
    this.iconSize = 24,
    super.label,
    required super.controller,
  ...
  @override
  State<_DyteIconButton> createState() => _DyteIconButtonState();
}

class _DyteIconButtonState extends State<_DyteIconButton> {
  @override
  Widget build(BuildContext context) {
